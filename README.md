...
Este es un proyecto de ecommerce básico que se utiliza para el curso de React de Coderhouse. La aplicación permite ver una lista de productos de una hamburguesería y realizar compras online. Los productos y las órdenes de compra se almacenan en una BD de Firebase.
